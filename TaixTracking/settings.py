"""
Django settings for TaixTracking project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'n-r1*(0@zn*f=*q9t_e2pv4d6+reb_dl$vn*t0tnqry92huafh')
...
ROOT_URLCONF = 'TaixTracking.urls'
...
WSGI_APPLICATION = 'TaixTracking.wsgi.application'
